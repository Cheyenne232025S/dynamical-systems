...
% STEP SIZE h = 0.1
[t1, X1] = heun(f, t0, tend, 0.1, x0);

% STEP SIZE h = 0.01
[t2, X2] = heun(f, t0, tend, 0.01, x0);

% STEP SIZE h = 0.001
[t3, X3] = heun(f, t0, tend, 0.001, x0);

% STEP SIZE h = 0.0001
[t4 , X4] = heun(f, t0, tend, 0.0001, x0);
...
legend('Heun h = 0.1', 'Analytic (ode45)', 'Location', 'northwest');
...
legend('Heun h = 0.01', 'Analytic (ode45)', 'Location', 'northwest');
...
legend('Heun h = 0.001', 'Analytic (ode45)', 'Location', 'northwest');
...
legend('Heun h = 0.0001', 'Analytic (ode45)', 'Location', 'northwest');
